...
function EquityChart({ equity, marketPrices, selectedMarketSeries, marketView, maxMaturityMonths, barrier, couponTrigger, couponTriggerLevel }) {
    ...
    <div className="resultChart">
      <ResponsiveContainer width="100%" height="100%">
        <LineChart data={data} margin={{ top: 18, right: selectedMarketSeries.length ? 26 : 14, bottom: 4, left: 14 }}>
          ...
          {marketView === "drawdown" && couponTrigger && selectedMarketSeries.length > 0 && <ReferenceLine yAxisId="market" y={couponTriggerLevel} stroke="#f97316" strokeDasharray="5 4" label={{ value: `Coupon trigger ${couponTriggerLevel}%`, fill: "#f97316", fontSize: 11 }} ifOverflow="extendDomain" />}
...
function TradeDetailChart({ trade, marketPrices, marketView, barrier, couponTrigger, couponTriggerLevel, selectedSeries }) {
